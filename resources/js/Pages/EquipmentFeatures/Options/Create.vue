                        ...
                        <form @submit.prevent="store" autocomplete="off">
                            ...
                            <div class="">
                                <div class="mb-4">
                                    ...
                                    <input type="text" v-model="form.name" id="name" class="appearance-none block w-full bg-gray-50 text-gray-700 border border-gray-400 rounded py-3 px-4">
...
export default {
    ...
    methods: {
        store() {
            this.form.post( route('equipment-features.options.store', this.data.id ) )
        },
    },
