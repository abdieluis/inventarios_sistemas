...
const deleteItem = ( feature, option  ) => {
    form.delete( route('equipment-features.options.destroy', [feature, option] ), {
        preserveScroll: true,
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <Dropdown width="48">
                                        ...
                                        <template #content>
                                            <div class="w-48">
                                                ...
                                                <DropdownLink v-if="true" :href="route('equipment-features.options.edit', [data.id, data.option.id] )">Editar</DropdownLink>
                                    ...
                                    <DialogModal :show="confirmingUserDeletion" max-width="xl" @close="closeModal">
                                        <template #title>Eliminar opción</template>
                                        <template #content>
                                        ...
                                        <template #footer>
                                            ...
                                            <DangerButton class="ml-3" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" @click="deleteItem( data.id, data.option.id )">
                                                Eliminar opción
                                            </DangerButton>
                                        </template>
                                    </DialogModal>
