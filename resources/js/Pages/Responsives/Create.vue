            ...
            <div class="max-w-2xl mx-auto px-6">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="p-6 sm:px-12 bg-white border-b border-gray-200">
                        ...
                        <div v-show="modalEmployments" tabindex="-1" aria-hidden="true"
                            class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full justify-center flex"
                            style="background-color:#000000a0;">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <div
                                        ...
                                        <button type="button"
                                            ...
                                            v-on:click="(modalEmployments = false)">
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <DataTable :columns="columnsEmployments" :data="db.employments"
                                            :options="optionsEmployments" ref="tableEmployments"
                                        ...
                                        <div v-else class="text-gray-500">
                                            <p
                                                class="text-base leading-relaxed text-gray-500 dark:text-gray-400 text-center p-4">
                        ...
                        <div v-show="modalEquipments" tabindex="-1" aria-hidden="true"
                            class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full justify-center flex"
                            style="background-color:#000000a0;">
                            <div class="relative w-full h-full max-w-2xl md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <div
                                        ...
                                        <button type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            v-on:click="(modalEquipments = false)">
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor"
                                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                        ...
                        <div v-show="modalPhonelines" tabindex="-1" aria-hidden="true"
                            class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full justify-center flex"
                            style="background-color:#000000a0;">
                            <div class="relative w-full h-full max-w-2xl md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <div
                                        ...
                                        <button type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            v-on:click="(modalPhonelines = false)">
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor"
                                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                    ...
                                    <div class="p-6 space-y-6">
                                        <DataTable :columns="columnsPhonelines" :data="db.phonelines"
                                            :options="optionsPhonelines" ref="tablePhonelines"
                                            class="table display w-100" />
                                    </div>
                                    <div class="flex justify-end p-6 space-x-2 border-t border-gray-200 rounded-b">
                                        <button type="button"
                                            class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
                                            v-on:click="(modalPhonelines = false)">Cancelar</button>
                                        <button type="button"
                                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            v-on:click="selectedPhoneline = selectedPhonelinesOnTable, modalPhonelines = false">Continuar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form @submit.prevent="store" autocomplete="off">
                            ...
                            <div class="">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <button type="button"
                                        class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-gray-600 bg-stone-100 rounded-lg border border-gray-100 hover:bg-stone-200 focus:ring-2 focus:outline-none focus:ring-stone-300"
                                        v-on:click="(modalEmployments = true)">
                                ...
                                <div class="bg-white shadow-md rounded mt-2 mb-8 flex flex-col">
                                    <div class="mb-0 p-2">
                                        <div class="flex" v-if="selectedEmployment == null">
                                            <a class="mx-4 my-6 hover:border-blue-500 hover:border-solid hover:bg-white hover:text-blue-500 group w-full flex flex-col items-center justify-center rounded-md border-2 border-dashed border-slate-300 text-sm leading-6 text-slate-900 font-medium py-3 cursor-pointer"
                                                v-on:click="(modalEmployments = true)">
                                                <svg class="group-hover:text-blue-400 mb-1 text-slate-400" width="20"
                                        ...
                                        <div v-else>
                                            <div class="flex flex-col items-center md:flex-row md:max-w-xl">
                                                ...
                                                <img v-if="selectedEmployment.employee_number == 319"
                                ...
                                <div class="flex items-center mt-6">
                                    ...
                                    <button type="button"
                                        class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-gray-600 bg-stone-100 rounded-lg border border-gray-100 hover:bg-stone-200 focus:ring-2 focus:outline-none focus:ring-stone-300"
                                        v-on:click="(modalEquipments = true)">
                                        <svg aria-hidden="true" class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                            ...
                                            <div v-for="(equipment, index) in selectedEquipments" :key="equipment.id"
                                                ...
                                                <div class="flex flex-col justify-between p-4 leading-normal">
                                                    ...
                                                    <div v-if="([3].includes(equipment.category_id))" class="">
                                                        <div class="">
                                                            <label for="status"
                                                                class="required block tracking-wide text-sm font-medium text-gray-900 mb-1">Linea
                                                                Teléfonica</label>
                                                            <VueMultiselect
                                                                v-model="selectedEquipments[index].phoneline"
                                                                :options="db.phonelines"
                                                                placeholder="Selecciona linea teléfonica" label="number"
                                                                track-by="id" :show-labels="false"></VueMultiselect>
                                                            <div v-if="errors.lifecycle" class="text-error">{{
                                                                errors.lifecycle
                                                                }}</div>
                                                        </div>
                                                        <div v-if="errors.phoneline" class="text-error">{{
                                                            errors.phoneline }}
                                                        </div>
                                                    </div>
                                ...
                                <div class="bg-white shadow-md rounded mt-2 mb-8 flex flex-col">
                                    <VueMultiselect v-model="form.accessories" :options="db.accessories"
                                        :multiple="true" placeholder="Selecciona los accesorios adicionales"
                                        label="name" track-by="id" :show-labels="false"></VueMultiselect>
                                ...
                                <div class="mb-6">
                                    <label for="start_at"
                                        ...
                                        entrega al
                                        usuario</label>
                                    <input type="date" v-model="form.start_at" id="start_at"
                                ...
                                <div class="mb-6">
                                    <label for="notes"
                                        class="block tracking-wide text-sm font-medium text-gray-900 mb-1">Observaciones</label>
                                    <textarea v-model="form.notes" id="notes"
                                        class="appearance-none block w-full bg-gray-50 text-gray-700 border border-gray-400 rounded py-3 px-4"></textarea>
                                    <div v-if="errors.notes" class="text-error">{{ errors.notes }}</div>
                                </div>

                                <div class="mb-4 mt-4 text-right">
                                    <a :href="route('responsives')"
                                    ...
                                    <button type="submit"
                                        class="ml-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registrar</button>
                                </div>
                            </div>
                        </form>
