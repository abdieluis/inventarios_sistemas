...
const deleteItem = ( id ) => {
    form.delete( route('equipment-categories.destroy', id ), {
        preserveScroll: true,
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <Dropdown width="48">
                                        ...
                                        <template #content>
                                            <div class="w-48">
                                                <div class="block px-4 py-2 text-xs text-gray-400">Category options</div>
                                                <DropdownLink v-if="true" :href="route('equipment-categories.edit', data.id )">Editar</DropdownLink>
