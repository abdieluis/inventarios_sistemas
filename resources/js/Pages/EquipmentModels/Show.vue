                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <Dropdown width="48">
                                        ...
                                        <template #content>
                                            <div class="w-48">
                                                <div class="block px-4 py-2 text-xs text-gray-400">Model options</div>
                                                <DropdownLink v-if="true" :href="route('equipment-models.edit', data.id )">Editar</DropdownLink>
                                    ...
                                    <DialogModal :show="confirmingUserDeletion" max-width="xl" @close="closeModal">
                                        <template #title>Eliminar Modelo</template>
                                        <template #content>
                            ...
                            <table class="w-full text-sm text-left text-gray-500">
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">Tipo de equipo</th>
                                        <td class="py-4 px-6">{{ data.category?.name }}</td>
                                    </tr>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap">Marca</th>
                                        <td class="py-4 px-6">{{ data.brand?.name }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
