...
onMounted(function () {
  ...
  dt.rows().every(function () {
    let row = this.data();
    let id = row.action;
    row.action = `<a class="block text-gray-600 hover:text-gray-800 bg-indigo-200 hover:bg-indigo-300 focus:ring-1 focus:outline-none focus:ring-indigo-400 font-medium rounded-lg text-sm px-2 py-1.5 text-center" href="equipment-brands/${id}">VER</a>`;
  });
});
          ...
          <div class="p-6 sm:px-12 bg-white border-b border-gray-200">
            ...
            <header class="bg-white mb-4">
              <div class="flex items-center justify-between">
                ...
                <a :href="route('equipment-brands.create')" class="hover:bg-blue-400 group flex items-center rounded-md bg-blue-500 text-white text-sm font-medium pl-2 pr-3 py-2 shadow-sm">
