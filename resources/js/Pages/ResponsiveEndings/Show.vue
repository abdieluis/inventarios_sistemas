...
const deleteItem = ( id ) => {
    form.delete( route('responsive-endings.destroy', id ), {
        preserveScroll: true,
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <Dropdown width="48">
                                        ...
                                        <template #content>
                                            <div class="w-48">
                                                <div class="block px-4 py-2 text-xs text-gray-400">Opciónes de finalización</div>
                                                <DropdownLink v-if="true" :href="route('responsive-endings.edit', data.id )">Editar</DropdownLink>
                                    ...
                                    <DialogModal :show="confirmingUserDeletion" max-width="xl" @close="closeModal">
                                        <template #title>Eliminar Motivo de finalización</template>
                                        <template #content>
                                        ...
                                        <template #footer>
                                            ...
                                            <DangerButton class="ml-3" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" @click="deleteItem( data.id )">
                                                Eliminar motivo de finalización
                                            </DangerButton>
                                        </template>
                                    </DialogModal>
