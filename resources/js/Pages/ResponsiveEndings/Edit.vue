                ...
                <div class="p-6 sm:px-12 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 mb-6">
                        <div class="mb-1 text-2xl">
                            Editar motivo de finalización
                        </div>
                        <div class="text-gray-500">
                            Actualiza los datos del motivo de finalización
                        </div>
                    </div>
                    ...
                    <form @submit.prevent="update" autocomplete="off">
                        ...
                        <div class="">
                            ...
                            <div class="mb-6">
                                <label for="name" class="block tracking-wide text-sm font-medium text-gray-900 mb-1">Motivo de finalización</label>
                            ...
                            <div class="mb-4 mt-4 text-right">
                                <a :href="route('responsive-endings.show', data.id)" class="text-gray-700 bg-gray-100 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Cancelar</a>
...
export default {
    ...
    data() {
        return {
            ...
            breadcrumbs: [
                { label: "Responsivas", url: route('responsives') },
                { label: "Finalizaciones de responsiva", url: route('responsive-endings') },
    ...
    methods: {
      update() {
            this.form.put( route('responsive-endings.update', this.data.id) )
        },
    },
