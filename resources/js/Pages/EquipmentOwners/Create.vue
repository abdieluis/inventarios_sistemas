                ...
                <div class="p-6 sm:px-12 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 mb-6">
                        ...
                        <div class="text-gray-500">
                            Completa los siguientes datos del propietario
                        </div>
                    </div>
                    ...
                    <form @submit.prevent="store" autocomplete="off">
                        ...
                        <div class="">
                            ...
                            <div class="mb-4">
                                <div v-if="errors.category_id" class="text-error">{{ errors.category_id }}</div>
                            </div>
                            
                            <div class="mb-6">
                                <label for="name" class="block tracking-wide text-sm font-medium text-gray-900 mb-1">Nombre del propietario</label>
                            ...
                            <div class="mb-4 mt-4 text-right">
                                <a :href="route('equipment-owners')" class="text-gray-700 bg-gray-100 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Cancelar</a>
...
export default {
    ...
    data() {
        return {
            ...
            breadcrumbs: [
                ...
                { label: "Propietarios", url: route('equipment-owners') },
                { label: "Nuevo" }
            ]
        }
    },
    ...
    methods: {
        store() {
            this.form.post( route('equipment-owners.store') )
        },
    },
