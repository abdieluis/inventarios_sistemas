                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <Dropdown width="48">
                                        ...
                                        <template #content>
                                            <div class="w-48">
                                                <div class="block px-4 py-2 text-xs text-gray-400">Branch options</div>
                                                <DropdownLink v-if="true" :href="route('branches.edit', data.id )">Editar</DropdownLink>
                                    ...
                                    <DialogModal :show="confirmingUserDeletion" max-width="xl" @close="closeModal">
                                        <template #title>Eliminar Planta</template>
                                        <template #content>
