            ...
            <div class="bg-white shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 sm:px-12 bg-white border-b border-gray-200">
                    ...
                    <form @submit.prevent="update" autocomplete="off">
                        <div class="">
                            <div class="mb-6">
                                <label for="name" class="block tracking-wide text-sm font-medium text-gray-900 mb-1">Nombre del puesto</label>
                            ...
                            <div class="mb-4 mt-4 text-right">
                                <a :href="route('employment-titles.show', data.id)" class="text-gray-700 bg-gray-100 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Cancelar</a>
...
export default {
    ...
    data() {
        return {
            ...
            breadcrumbs: [
                ...
                { label: "Puestos", url: route('employment-titles') },
    ...
    methods: {
      update() {
            this.form.put( route('employment-titles.update', this.data.id) )
        },
    },
