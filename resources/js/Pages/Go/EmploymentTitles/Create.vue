                    ...
                    <div class="p-6 sm:px-12 bg-white border-b border-gray-200">
                        ...
                        <div class="mt-6 mb-6">
                            ...
                            <div class="text-gray-500">
                                Completa los siguientes datos del puesto
                            </div>
                        </div>
                        ...
                        <form @submit.prevent="store" autocomplete="off">
                            ...
                            <div class="mb-6 text-rigth text-right">
                                <a :href="route('employment-titles')" class="text-gray-700 bg-gray-100 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Cancelar</a>
...
export default {
    ...
    methods: {
        store() {
            this.form.post( route('employment-titles.store') )
        },
    },
