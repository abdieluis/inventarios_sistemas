...
let selectedEquipmentOnTable = null;
...
onMounted(function () {
    ...
    dtEquipments.on( 'select', function ( e, dt, type, indexes ) {
        if ( type === 'row' ) {
            selectedEquipmentOnTable = dt.rows( indexes[0] ).data();
            selectedEquipmentOnTable = selectedEquipmentOnTable[0];
        }
    });
                            ...
                            <div class="relative w-full h-full max-w-2xl md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <!--search-input route-name="equipment-responsives.choose-employee" /-->
                            ...
                            <div class="relative w-full h-full max-w-2xl md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="flex justify-end p-6 space-x-2 border-t border-gray-200 rounded-b">
                                        ...
                                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" v-on:click="selectedEquipment=selectedEquipmentOnTable, modalEquipments=false">Continuar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form @submit.prevent="store" autocomplete="off">
                            ...
                            <div class="">
                                    ...
                                    <div class="mb-0 p-2">
                                        ...
                                        <div v-else>
                                            <div class="flex flex-col items-center md:flex-row md:max-w-xl">
                                                <img class="object-cover w-full rounded-t-lg h-32 md:h-auto md:w-24 md:rounded-none md:rounded-l-lg" src="https://img.icons8.com/ios/500/user--v1.png" alt="...">
                                ...
                                <div class="flex items-center mt-6">
                                    <div class="relative w-full">
                                        <h5 class="text-lg font-large font-bold">Equipo</h5>
                                    </div>
                                ...
                                <div class="bg-white shadow-md rounded mt-2 mb-8 flex flex-col">
                                    <div class="mb-0 p-2">
                                        <div v-if="(selectedEquipment==null)" class="flex">
                                        ...
                                        <div v-else>
                                            <div class="flex flex-col items-center md:flex-row md:max-w-xl">
                                                ...
                                                <div class="flex flex-col justify-between p-4 leading-normal">
                                                    <h5 class="mb-2 text-lg tracking-tight text-gray-900">
                                                        {{ selectedEquipment.category_name }} {{ selectedEquipment.brand_name }} {{ selectedEquipment.model_name }}
                                                    </h5>
                                                    <p class="mb-3 font-normal text-gray-600">
                                                        Placa: {{ selectedEquipment.sku }}, No. serie: {{ selectedEquipment.serial }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div v-if="errors.equipment" class="text-error">{{ errors.equipment }}</div>
                                ...
                                <div class="mb-6">
                                    <label for="amount" class="block tracking-wide text-sm font-medium text-gray-900 mb-1">Importe de la responsiva</label>
                                ...
                                <div class="mb-4 mt-4 text-right">
                                    <a :href="route('equipment-responsives')" class="text-gray-700 bg-gray-100 hover:bg-gray-200 focus:ring-2 focus:outline-none focus:ring-gray-400 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Cancelar</a>
...
export default {
    ...
    methods: {
        ...
        store() {
            ...
            this.form.equipment = this.selectedEquipment?.id;
            this.form.employment = this.selectedEmployment?.id;

            console.log( this.form );
            console.log( this.form.accessories );

            console.log( this.form.equipment );
            console.log( this.form.employment );

            Inertia.post('/equipment-responsives', this.form );
            //this.form.post('/equipment-responsives');
        },
